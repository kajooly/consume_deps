...
config :comsume_deps, ComsumeDepsWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "K1Idxb9LEN93kAKo9QAl9vgA6tc7rU31WWZT4PczjUpOJvv865NAl2NVNAm1RsEX",
  watchers: [
...
config :comsume_deps, ComsumeDepsWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/comsume_deps_web/(live|views)/.*(ex)$",
      ~r"lib/comsume_deps_web/templates/.*(eex)$"
    ]
  ]
